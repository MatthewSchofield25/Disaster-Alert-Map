...
class Prisma(AsyncBasePrisma):
    ...
    def _default_datasource(self) -> Datasource:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'sqlserver://weatherapplicationserver.database.windows.net:1433;initial catalog=Bluesky_Posts;user=weatheremergencyapplication;password=Weather123;', 'fromEnvVar': None}).resolve(),
