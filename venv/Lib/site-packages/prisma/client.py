...
SCHEMA_PATH = Path('C:/Users/eliza/OneDrive/Desktop/Natural-Disaster-Alert/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\eliza\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    bluesky_posts: 'actions.Bluesky_PostsActions[models.Bluesky_Posts]'
    lstm_posts: 'actions.LSTM_PostsActions[models.LSTM_Posts]'
    ...
    def __init__(
        ...
        *,
        ...
        self._set_generated_properties(
            ...
            active_provider='sqlserver',
            default_datasource_name='db',
        )

        self.bluesky_posts = actions.Bluesky_PostsActions[models.Bluesky_Posts](self, models.Bluesky_Posts)
        self.lstm_posts = actions.LSTM_PostsActions[models.LSTM_Posts](self, models.LSTM_Posts)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/eliza/OneDrive/Desktop/Natural-Disaster-Alert/schema.prisma',
        }
...
class Batch:
    bluesky_posts: 'Bluesky_PostsBatchActions'
    lstm_posts: 'LSTM_PostsBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.bluesky_posts = Bluesky_PostsBatchActions(self)
        self.lstm_posts = LSTM_PostsBatchActions(self)
...
class Bluesky_PostsBatchActions:
