    ...
    #Liz: test previously read a csv, now received as pd dataframe from KenLSTMModel.py
    ...
    relevant_posts["cleaned_text"] = relevant_posts["text"].apply(preprocess_data)
    ...
    wc.generate(' '.join(relevant_posts['Cleaned_text']))
    ...
    test = relevant_posts[~relevant_posts['Cleaned_text'].apply(lambda x: contains_keywords(x, keywords_to_remove))]
    '''
